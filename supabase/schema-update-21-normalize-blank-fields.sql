-- ===========================================================================
-- Schema update 21 - blank optional fields normalize to NULL on leads.
--
-- GENERATED FILE. Regenerate from supabase/migrations/, do not hand-edit.
-- Apply updates 1-20 first. Re-runnable throughout.
--
-- Fixes a live failure: n8n's direct-insert workflow sends "" (not null) for
-- a missing email, which trips leads_email_format (only NULL is exempt) and
-- rejects the whole row. Turns blank into null for email, website, phone,
-- city, country, niche before the CHECK constraints ,and dedupe key
-- computation ,ever see them. business_name is deliberately untouched.
-- ===========================================================================
