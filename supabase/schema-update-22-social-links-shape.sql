-- ===========================================================================
-- Schema update 22 - social_links normalizes to an OBJECT.
--
-- GENERATED FILE. Regenerate from supabase/migrations/, do not hand-edit.
-- Apply updates 1-21 first, and 0031 specifically before this one ,see the
-- ordering note in the migration file below. Re-runnable throughout.
--
-- Fixes a live failure: n8n's "Update a row" node sent leads.social_links a
-- JSON STRING (the literal text "{}", or raw prose) instead of a JSON OBJECT,
-- which is valid jsonb but trips leads_social_links_is_object. Extends the
-- same trigger from update 21 so a string that parses as a JSON object is
-- unwrapped, other text survives under "_raw", and anything else with no
-- sensible object reading becomes {} ,matching normalizeSocialLinks() in
-- lib/import/normalize.ts exactly.
-- ===========================================================================
