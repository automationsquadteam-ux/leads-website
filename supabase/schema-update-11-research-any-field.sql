-- ===========================================================================
-- Schema update 11 - research counts as done when ANY research field is filled.
--
-- GENERATED FILE. Regenerate from supabase/migrations/, do not hand-edit.
-- Apply updates 1-10 first. Re-runnable: the backfill is guarded.
--
-- research_complete was driven by research_summary alone, but the upstream
-- enrichment writes seven separate fields and the summary is often the missing
-- one. 239 leads had genuine research (website observations, automation and
-- chatbot opportunities, outreach angle) and were reported as still needing it,
-- so their next step read "Research Lead" for work already done.
--
-- personalization is deliberately excluded: it is the hook line used in the
-- draft, not research, and 688 of 698 leads have it, which would make the flag
-- true for essentially everything.
-- ===========================================================================
-- ---------------------------------------------------------------------------
