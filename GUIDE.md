...
| 0034 | `20260810140000_exclude_archived_everywhere.sql` | ❌ **NOT YET** — paste `schema-update-24-exclude-archived.sql` |
| 0035 | `20260810150000_send_queue_view.sql` | ❌ **NOT YET** — paste `schema-update-25-send-queue-view.sql`. **The sender is dead until this runs.** |
