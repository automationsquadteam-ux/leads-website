...
**0001 through 0039, 0042 and 0043 are applied; 0040, 0041 and 0044 are not yet pasted.** This table had drifted stale more than once by this point
...
**0044 is now taken** (website-rejects-social-media-links, added 2026-08-20 — see the migration
table above). **The next migration after that is 0045.** Add the file, regenerate `schema.sql` and
a `schema-update-N-*.sql` bundle, and leave its row as NOT YET until it has actually been probed —
